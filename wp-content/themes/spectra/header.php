...
<head>
	...
	<?php if ( $spectra_opts->get_option( 'favicon' ) && $spectra_opts->get_option( 'favicon' ) !== '' ) : ?>
	<link rel="shortcut icon" type="image/x-icon" href="<?php echo esc_url( $spectra_opts->get_option( 'favicon' ) ) ?>">
	<link rel="apple-touch-icon" href="<?php echo esc_url( $spectra_opts->get_option( 'favicon' ) ) ?>"/>
	<?php endif; ?>
	<?php wp_head(); ?>
</head>
<?php 
...
<div id="site" class="site <?php echo esc_attr( $show_nav ) ?>">
	...
	<div id="slidemenu-layer" class="show"></div>
