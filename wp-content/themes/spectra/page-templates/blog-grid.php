						...
						switch ( get_post_format() ) {
							...
							case 'video':
								...
								if ( $video_yt_id && $video_yt_id !== '' ) {
									$media .= '<div class="video"><iframe src="https://www.youtube.com/embed/' . $video_yt_id . '" width="' . $width . '" height="' . $height . '"></iframe></div>';
								} else if ( $video_vimeo_id && $video_vimeo_id !== '' ) {
									$media .= '<div class="video"><iframe src="https://player.vimeo.com/video/' . $video_vimeo_id . '" width="' . $width . '" height="' . $height . '"></iframe></div>';
								}
