                    ...
                    case 'audio' :
                        ...
                        if ( function_exists( 'scamp_player_get_list' ) && scamp_player_get_list( $tracks_id ) ) {
                            ...
                            if ( count( $tracklist ) === 1 ){
                                ...
                                $thumb_attr = $thumb_attr . ' data-cover="' . esc_attr( $tracklist[0]['cover'] ) . '"';
                            ...
                            // Tracks
                                ...
                                foreach ( $tracklist as $track ) {
                                    ...
                                    $hidden_tracklist .= '<li><a href="' . esc_url( $track['url'] ) . '" data-cover="' . esc_attr( $track['cover'] ) . '" class="sp-play-track">' . $track['title'] . '</a></li>' ."\n";
                                }
                                $hidden_tracklist .= '</ul>'."\n";
                            }
