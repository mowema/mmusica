...
<div id="page">
	...
	<div class="container clearfix">
	    ...
	    <header class="content-header">
	        <h1 class="content-title animated" data-delay="0"><?php the_title(); ?></h1>
	        <span class="sub-heading animated" data-delay="100"><?php echo get_the_term_list( $wp_query->post->ID, 'spectra_event_categories', '', ' / ', '' ); ?></span>
	        <hr class="content-line animated" data-delay="200">
	    </header>
	    <!-- /content header -->
		<?php endif; ?>
