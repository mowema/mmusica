...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry">
		...
		<div class="entry-media content-video animated" data-delay="100">
			<div class="video">
				<iframe src="https://www.youtube.com/embed/<?php echo esc_attr( $video_yt_id ) ?>" width="<?php echo esc_attr( $width ) ?>" height="<?php echo esc_attr( $height ) ?>"></iframe>
			</div>
		</div>
		...
		<div class="entry-media content-video animated" data-delay="100">
			<div class="video">
				<iframe src="https://player.vimeo.com/video/<?php echo esc_attr( $video_vimeo_id ) ?>" width="<?php echo esc_attr( $width ) ?>" height="<?php echo esc_attr( $height ) ?>"></iframe>
			</div>
		</div>
